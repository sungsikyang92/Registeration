...
public class ScheduleFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle b){
        ...
        wednesday[0] = (TextView) getView().findViewById(R.id.tuesday0);
        wednesday[1] = (TextView) getView().findViewById(R.id.tuesday1);
        wednesday[2] = (TextView) getView().findViewById(R.id.tuesday2);
        wednesday[3] = (TextView) getView().findViewById(R.id.tuesday3);
        wednesday[4] = (TextView) getView().findViewById(R.id.tuesday4);
        wednesday[5] = (TextView) getView().findViewById(R.id.tuesday5);
        wednesday[6] = (TextView) getView().findViewById(R.id.tuesday6);
        wednesday[7] = (TextView) getView().findViewById(R.id.tuesday7);
        wednesday[8] = (TextView) getView().findViewById(R.id.tuesday8);
        wednesday[9] = (TextView) getView().findViewById(R.id.tuesday9);
        wednesday[10] = (TextView) getView().findViewById(R.id.tuesday10);
        wednesday[11] = (TextView) getView().findViewById(R.id.tuesday11);
        wednesday[12] = (TextView) getView().findViewById(R.id.tuesday12);
        wednesday[13] = (TextView) getView().findViewById(R.id.tuesday13);
    ...
    class BackGroundTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute(){
            try{
                target = "http://sungsikyang92.cafe24.com/ScheduleList.php?userID=" + URLEncoder.encode(MainActivity.userID, "UTF-8");
            }catch (Exception e){
                e.printStackTrace();
            }
